...
ki = LINETCR.LINE()
ki.login(token="ErQZUDkT2ezsnWLQjTs1.QLyVrn/7ce0rYYmzu5Bcyq.FVvrK+Z38f78oSWSXCCZYrMcmAaqNKlrqZTHUDjv0lg=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EroLaBKCEW1ZNNiqByIe.zieevjMpKYrx8lPQ/O4TxG.e6z3NFyhrikHqD6czpxGuWymwfhUceNa7nfe1USJ8ag=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="ErE8Y23veaNybyRtFiT0.OKWky3kb60pcfWQ/EMbTGa.x+PI/lqAN1F/J+CNc+CNmsmGwEoIRsJk9UzmN5LffT8=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="Erq2e3f9p1LYPsFlU9if.r5RawF4wXYQhVUlqKb6mpW.q93AvswLyDVx1WFyhaq/T1jbgNj2c/qxQje852WpebY=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="ErADSjqKQkeyAGTM7VWc.kAk9CwLPKKq4oshOZSf8la.ydYdiIPAu4WYQgVp79FXpITkPETr3TFwx2PHIoP5TvE=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="ErTV0ZUFk5MIBRSGUGK0./2s3MoOflkpNH0r0WetOqa.UVbn2eX2X0lzRY+Kml4RhIofpgXGTZbUzcSh2+Bvd4Q=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="Er8oCbtbUNvJKiDUgARf.NbF/Fo9xTFqH5km5uqdJtW.cWUMrD3Ncu/KYjTygb/sBC4qBUtxdm+hy9kMh+VTObs=")
kg.loginResult()
